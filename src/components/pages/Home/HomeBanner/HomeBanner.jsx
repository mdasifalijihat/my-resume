      ...
      <div className="hero-content flex-col lg:flex-row-reverse gap-8">
        ...
        >
          ...
          <p className="py-6 text-base-content leading-relaxed max-w-2xl">
            ...
            building <span className="text-primary font-medium">responsive</span>,{" "}
            ...
            performance. Eager to contribute to innovative projects and deliver
            impactful solutions as part of a{" "}
            <span className="text-accent font-medium">dynamic development team</span>.
          </p>
